...
em2h.write_indices_and_values(s1, l1[:,0], path_mask+'J_stars_Nobs_mean_o.%d_t.%d_%s_NESTED_2SL%d.fits'%(nside_out, nside_tiny,coord, L))
em2h.write_indices_and_values(s1, l2[:,0], path_mask+'J_stars_Nobs_frac2_o.%d_t.%d_%s_NESTED_2SL%d.fits'%(nside_out, nside_tiny,coord, L))
em2h.write_indices_and_values(s1, l3[:,0], path_mask+'J_stars_Nobs_frac3_o.%d_t.%d_%s_NESTED_2SL%d.fits'%(nside_out, nside_tiny,coord, L))
em2h.write_indices_and_values(s1, l4[:,0], path_mask+'J_stars_Nobs_frac4_o.%d_t.%d_%s_NESTED_2SL%d.fits'%(nside_out, nside_tiny,coord, L))
em2h.write_indices_and_values(s2, l5[:,0], path_mask+'J_stars_Nobs_tiny_t.%d_%s_NESTED_2SL%d.fits'%( nside_tiny,coord, L))
