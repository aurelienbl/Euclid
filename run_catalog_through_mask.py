...
t0=time.time()
em2h.write_indices_and_values(h[1].data.field('unique_gal_id'),N_obs ,'/data63/benoitl/Euclid/MICE2/Nobs_82_VIS.fits')
em2h.write_indices_and_values(h[1].data.field('unique_gal_id'),star_vis ,'/data63/benoitl/Euclid/MICE2/star_flag_82_VIS.fits')
